...
useHead({
  title: 'AI恋爱大师 - 极客风格AI情感对话',
  meta: [
    { name: 'description', content: '与AI恋爱大师极客风格对话，获取情感建议，体验酷炫智能。' },
    { name: 'keywords', content: 'AI, 恋爱, 情感, 极客, 智能对话, 酷炫, HGL' },
    { property: 'og:title', content: 'AI恋爱大师 - 极客风格AI情感对话' },
    { property: 'og:description', content: '极客风格，酷炫体验，AI恋爱大师为你解答情感问题。' },
